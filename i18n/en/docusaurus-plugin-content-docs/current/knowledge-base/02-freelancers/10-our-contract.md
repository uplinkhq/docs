...
Before we can introduce you to a client for a [direct job](04-direct-jobs.md), we ask you to sign our contract, which includes the following points:

1. If you start working with a client, which you got in contact with via Uplink, we will charge you [a fee of 10% of what you invoice to the client](09-our-fee.md) for the first 12 months of your collaboration. This fee only applies if the collaboration starts within 12 months of our introduction.
...
Since there is no fee for [recruiter jobs](05-recruiter-jobs.md), you can apply for them without signing the contract.
